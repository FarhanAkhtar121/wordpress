<?php
if (!class_exists('AFTWPL_Product_Grid')) :
    /**
     * Adds AFTWPL_Product_Grid widget.
     */
    class AFTWPL_Product_Grid extends AFTWPL_Widget_Base
    {
        /**
        ...
        function __construct()
        {
            ...
            $this->select_fields = array('aftwpl-select-product-category', 'aftwpl-select-product-orderby', 'aftwpl-select-product-order');

            $widget_ops = array(
                'classname' => 'aftwpl_product_grid',
                'description' => __('Displays products from selected category in single column.', 'woo-product-showcase'),
                'customize_selective_refresh' => true,
            );

            parent::__construct('aftwpl_product_grid', __('AFT Products Grid', 'woo-product-showcase'), $widget_ops);
        }
        ...
        public function widget($args, $instance)
        {
            ...
            $number_of_products = isset($instance['aftwpl-product-number']) ? $instance['aftwpl-product-number'] : '6';
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::aftwpl_generate_text_input('aftwpl-categorised-product-title', 'Title', 'AFT Product Grid');
                ...
                echo parent::aftwpl_generate_text_input('aftwpl-product-number', __('Number of products', 'woo-product-showcase'), '6', 'number');
                echo parent::aftwpl_generate_select_options('aftwpl-select-product-show', __('Show', 'woo-product-showcase'), $show);

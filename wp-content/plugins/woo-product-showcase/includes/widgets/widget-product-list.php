<?php
if (!class_exists('AFTWPL_Product_List')) :
    /**
     * Adds AFTWPL_Product_List widget.
     */
    class AFTWPL_Product_List extends AFTWPL_Widget_Base
    {
        /**
        ...
        function __construct()
        {
            ...
            $widget_ops = array(
                'classname' => 'aftwpl_product_list',
                'description' => __('Displays products from selected category in single column.', 'woo-product-showcase'),
                'customize_selective_refresh' => true,
            );

            parent::__construct('aftwpl_product_list', __('AFT Products List', 'woo-product-showcase'), $widget_ops);
        }
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::aftwpl_generate_text_input('aftwpl-categorised-product-title', 'Title', 'AFT Product List');

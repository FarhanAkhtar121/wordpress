...
Contributors: khubbaib,hamza4547,faiz-ali,vip.sajjad
Donate link: https://ulcwp.com/pricing-plans/
Tags: Live score, Live Cricket,Live IPL,Live Matches,cricket,IPL,live cricket score
...
**(Note)** This Plugin is relying on a 3rd party (https://www.cricket.com.au) as a service  API to pull data.

**Pro Version**

[Buy Pro Version](http://ulcwp.com/pricing-plans/)

**Refer and Make Money**

[Make Money](http://ulcwp.com/make-money/)

**Live preview**

[Live preview](http://www.wpbestplugins.club/)

**What type of site you can developer to use pro version**

[CricnLive](http://cricnlive.com)
[crickethighlightshd](https://www.crickethighlightshd.com/)
...
*  Series List
*  Series Matches
*  Series Matches Shortcode Via Visual Bakery( Visual Composer)
...
1. Series Page Layout 2 (All current, upcoming and completed Series will be listed here).
2. Series Page Layout 1 (All current, upcoming and completed Series will be listed here).
3. Series Live&Upcoming Matches ( All matches for sepecific series).
4. Series Completed Matches ( All matches for sepecific series).
5. Match Detail Page (All detail for sepecific Match).
6. Match ball by ball Commentary ( Detail commentary for sepecific Match ).
7. Players in match ( All Players which is playing in sepecific Match).
8. Player Stats Page ( All bowling, batting Stats for sepecific Player).
9. Player PartnerShips (Available in [Pro version](http://ulcwp.com/pricing-plans/).
10.Team Score Graphs for every over.  (Available in [Pro version](http://ulcwp.com/pricing-plans/).
11.Players Stats for sepecific series (Most runs,Most wickets,most catches and sixes in series).
12.Sidebar Widget (All Live,Completed, Upcoming matches in WordPress native Widget which can be put anywhere in website.Available in [Pro version](http://ulcwp.com/pricing-plans/) 